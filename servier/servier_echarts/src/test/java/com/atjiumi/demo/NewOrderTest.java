...
//        echartsOrderMapper.selectEchartsOrder();
...
//        echartsNavigationMapper.selectEchartsEchartsNavigation();
//
//
//        /**
//         * 3目的国数据
...
//
        ...
        System.out.println(echartsMaps);
        echartsMapMapper.insertEchartsMaps(echartsMaps);
        //echartsMapMapper.selectEchartsMaps();
...
//        echartsCommodityMapper.selectEchartsCommodity();
//
//
//        /**
//         * 6历史数据
...
//        echartsMapChartMapper.INSERTMapChartTodayTop(echartsMapCharts);
    ...
    @Test
    public void cao(){
        BcoDeclarationStatisticsMapper bean = ApplicationContextUtils.getBean(BcoDeclarationStatisticsMapper.class);
...
//将Object 类型转成BigDecima
    ...
    public void TestJson(){
        ...
        System.out.println("进入添加方法，现在执行调用接口方法");
        TestData testData =new TestData();
        System.err.println("TestData对象"+testData);
...
//
        ...
        System.err.println("对象注入不到："+bcoDeclarationStatisticsMapper);

        //private BcoDeclarationStatisticsMapper bcoDeclarationStatisticsMapper;
        BcoDeclarationStatisticsMapper bd= ApplicationContextUtils.getBean(BcoDeclarationStatisticsMapper.class);
         bd.InsertBcoDeclarationStatistics(bdsList);
    }
